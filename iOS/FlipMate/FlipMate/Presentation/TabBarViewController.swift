...
private extension TabBarViewController {
    ...
    func configureUI() {
        let timerViewController = TimerViewController(timerViewModel: TimerViewModel(timerUseCase: DefaultTimerUseCase(timerRepository: DefaultTimerRepsoitory(provider: Provider(urlSession: URLSession.shared)))))
